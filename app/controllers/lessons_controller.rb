...
class LessonsController < ApplicationController
  ...
  def create
    ...
    if @lesson.save
      ...
      hash = { searchable_id: @lesson.id, searchable_type: 'Lesson', title: @lesson.title, description: @lesson.description, subject: @course.subject, state: @course.state, district: @course.district, grade_level: @course.grades.pluck(:grade_level).join(' '), tags: lesson_tags, user_id: current_user.id, last_name: current_user.last_name, status: current_user.status } 
