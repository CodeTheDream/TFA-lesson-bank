...
RSpec.describe "Users", type: :request do  
  ...
  describe "get edit_user_path" do
    ...
    it "will render the :edit template if your role is admin with status approved and you try to edit a creator's account with status Approved" do
      ...
      sign_in @admin1
      @admin1.confirm
      #Admin try to edit creator with status Approved
